...
How to connect your node to QSC block chain?
    In your router setting, port forwarding the port 19001 and 19009 of the router IP to the those of the host IP.
