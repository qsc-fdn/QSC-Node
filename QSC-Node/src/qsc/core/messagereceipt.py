...
from qsc.core.Message import Message
from qsc.core.MessageRequest import MessageRequest
from qsc.core.txs.CoinBase import CoinBase
from qsc.generated import qsclegacy_pb2
from qsc.generated.qsclegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        qsclegacy_pb2.LegacyMessage.VE: 'veData',
        qsclegacy_pb2.LegacyMessage.PL: 'plData',
        qsclegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        qsclegacy_pb2.LegacyMessage.MR: 'mrData',
        qsclegacy_pb2.LegacyMessage.SFM: 'mrData',

        qsclegacy_pb2.LegacyMessage.BK: 'block',
        qsclegacy_pb2.LegacyMessage.FB: 'fbData',
        qsclegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        qsclegacy_pb2.LegacyMessage.TX: 'txData',
        qsclegacy_pb2.LegacyMessage.MT: 'mtData',
        qsclegacy_pb2.LegacyMessage.TK: 'tkData',
        qsclegacy_pb2.LegacyMessage.TT: 'ttData',
        qsclegacy_pb2.LegacyMessage.LT: 'ltData',
        qsclegacy_pb2.LegacyMessage.SL: 'slData',

        qsclegacy_pb2.LegacyMessage.EPH: 'ephData',

        qsclegacy_pb2.LegacyMessage.SYNC: 'syncData',

        qsclegacy_pb2.LegacyMessage.MC: 'mcData',
        qsclegacy_pb2.LegacyMessage.MS: 'msData',
        qsclegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[qsclegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = qsclegacy_pb2.LegacyMessage(**{'func_name': msg_type,
