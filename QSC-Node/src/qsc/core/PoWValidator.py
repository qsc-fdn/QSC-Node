...
from qsc.core.Singleton import Singleton
from qsc.core.miners.qryptonight7.CNv1PoWValidator import CNv1PoWValidator
from qsc.core.miners.qrandomx.QRXPoWValidator import QRXPoWValidator
