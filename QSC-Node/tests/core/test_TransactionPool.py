...
class TestTransactionPool(TestCase):
    ...
    @patch('qsc.core.TransactionPool.TransactionPool.is_full_transaction_pool', autospec=True)
    ...
    @patch('qsc.core.TransactionPool.config', autospec=True)
    ...
    @patch('qsc.core.TransactionPool.TransactionPool.is_full_pending_transaction_pool', autospec=True)
    ...
    @patch('qsc.core.TransactionPool.logger')
    @patch('qsc.core.TransactionPool.TransactionPool.is_full_pending_transaction_pool', autospec=True)
    ...
    @patch('qsc.core.TransactionPool.logger')
    @patch('qsc.core.txs.Transaction.Transaction.from_pbdata', return_value=make_tx())
    @patch('qsc.core.TransactionPool.TransactionPool.add_tx_to_pool', return_value=True)
    ...
    @patch('qsc.core.txs.Transaction.Transaction.from_pbdata', new=replacement_from_pbdata)
    ...
    @patch('qsc.core.TransactionInfo.config', autospec=True)
    @patch('qsc.core.TransactionPool.TransactionPool.is_full_transaction_pool', return_value=False)
