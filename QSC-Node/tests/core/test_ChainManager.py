...
from qsc.generated import qrlstateinfo_pb2
from qsc.core import config
from qsc.crypto.xmss import XMSS
from qsc.crypto.QRandomX import QRandomX
...
class TestChainManagerReal(TestCase):
    ...
    @patch('qsc.core.misc.ntp.getTime')
    ...
    @patch("qsc.core.DifficultyTracker.DifficultyTracker.get")
    def test_add_block(self, mock_difficulty_tracker_get):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            with patch('qsc.core.misc.ntp.getTime') as time_mock:
                time_mock.return_value = 1615270948  # Very high to get an easy difficulty
...
class TestChainManager(TestCase):
    ...
    @patch('qsc.core.Block.Block', autospec=True)
    ...
    @patch('qsc.core.config')
    @patch('qsc.core.ChainManager.ChainManager.re_org_limit', new_callable=PropertyMock)
