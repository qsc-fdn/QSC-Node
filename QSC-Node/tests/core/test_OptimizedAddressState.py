...
class TestOptimizedAddressState(TestCase):
    ...
    @patch('qsc.core.config.DevConfig.ots_tracking_per_page', new_callable=PropertyMock, return_value=1024)
    @patch('qsc.core.config.DevConfig.ots_bitfield_size', new_callable=PropertyMock)
