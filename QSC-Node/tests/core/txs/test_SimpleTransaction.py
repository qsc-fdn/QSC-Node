...
from qsc.core.TransactionInfo import TransactionInfo
...
class TestSimpleTransaction(TestCase):
    ...
    @patch('qsc.core.txs.Transaction.config')
    def test_validate_tx_invalid(self, m_config, m_logger):
        ...
        with patch('qsc.core.txs.TransferTransaction.TransferTransaction.amounts',
        ...
        with patch('qsc.core.txs.TransferTransaction.TransferTransaction.fee', new_callable=PropertyMock) as m_fee:
            m_fee.return_value = -1
            with self.assertRaises(ValueError):
                self.tx.validate_or_raise()
        with patch('qsc.core.txs.TransferTransaction.TransferTransaction.addrs_to',
        ...
        with patch('qsc.core.txs.TransferTransaction.TransferTransaction.addrs_to',
            ...
            with self.assertRaises(ValueError):
                self.tx.validate_or_raise()
        with patch('qsc.core.txs.TransferTransaction.TransferTransaction.addr_from',
