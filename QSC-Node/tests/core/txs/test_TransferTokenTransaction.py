...
class TestTransferTokenTransaction(TestCase):
    ...
    def test_state_validate_tx_custom(self, m_logger):
        ...
        tx = TransferTokenTransaction.create(**params)
        tx.sign(self.alice)
        with patch('qsc.core.txs.Transaction.Transaction.fee', new_callable=PropertyMock) as m_fee:
        ...
        tx = TransferTokenTransaction.create(**params)
        tx.sign(self.alice)
        with patch('qsc.core.txs.TransferTokenTransaction.TransferTokenTransaction.addrs_to',
    ...
    def test_validate_extended(self, m_validate_slave, m_logger):
        ...
        # fee = -1
        with patch('qsc.core.txs.TransferTokenTransaction.TransferTokenTransaction.fee',
        ...
        # total_amount = -1
        with patch('qsc.core.txs.TransferTokenTransaction.TransferTokenTransaction.total_amount',
        ...
        tx = TransferTokenTransaction.create(**params)
        tx.sign(self.alice)
        with patch('qsc.core.config', autospec=True) as m_config:
