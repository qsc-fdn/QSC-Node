...
from qsc.core.node import POW
from qsc.generated import qrl_pb2
...
class TestQRLNodeReal(TestCase):
    ...
    @patch('qsc.core.qrlnode.QRLNode.block_height', new_callable=PropertyMock, return_value=19)
...
class TestQRLNode(TestCase):
    ...
    @patch('qsc.core.BlockMetadata.BlockMetadata.get_block_metadata')
    ...
    @patch('qsc.core.PaginatedData.PaginatedData.get_paginated_data')
    @patch('qsc.core.OptimizedAddressState.OptimizedAddressState.get_optimized_address_state')
    @patch('qsc.core.TransactionMetadata.TransactionMetadata.get_tx_metadata')
    ...
    @patch('qsc.core.Block.Block.get_block')
    ...
    @patch('qsc.core.Block.Block.get_block_by_number')
    ...
    @patch('qsc.core.LastTransactions.LastTransactions.get_last_txs')
    ...
    def test_get_block_timeseries(self):
        ...
        with patch('qsc.core.qrlnode.QRLNode.block_height', new_callable=PropertyMock, return_value=0):
            result = self.qrlnode.get_block_timeseries(3)
            result_converted_from_iterator = [r for r in result]  # []
    ...
    @patch('qsc.core.BlockMetadata.BlockMetadata.get_block_metadata')
    @patch('qsc.core.Block.Block.get_block_by_number')
    @patch('qsc.core.ChainManager.ChainManager.height', new_callable=PropertyMock, return_value=3)
...
class TestQRLNodeProperties(TestCase):
    ...
    def test_uptime_network(self, mock_get_block_by_number):
        ...
        with patch('qsc.core.misc.ntp.getTime') as m_getTime:
    ...
    @patch('qsc.core.ChainManager.ChainManager.get_measurement')
    @patch('qsc.core.BlockMetadata.BlockMetadata.get_block_metadata')
