...
from qsc.generated import qrl_pb2, qrllegacy_pb2
...
@patch('qsc.core.p2p.p2pfactory.logger', autospec=logger, name="Mock Logger")
@patch('qsc.core.p2p.p2pfactory.reactor', autospec=reactor, name="My Mock Reactor")
class TestP2PFactory(TestCase):
    ...
    @patch('qsc.core.p2p.p2pfactory.config', autospec=True)
    ...
    def test_monitor_connections(self, m_reactor, m_logger):
        ...
        with patch('qsc.core.p2p.p2pfactory.config', autospec=True) as m_config:
