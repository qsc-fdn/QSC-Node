...
from qsc.core.p2p import p2pPeerManager
from qsc.core.p2p.p2pfactory import P2PFactory, p2p_msg_priority
from qsc.core.p2p.p2pprotocol import P2PProtocol
from qsc.core.qrlnode import QRLNode
from qsc.generated import qrllegacy_pb2
...
class TestP2PProtocol(TestCase):
    ...
    def setUp(self):
        with patch('qsc.core.misc.ntp.getTime', new=replacement_getTime):
    ...
    @patch('qsc.core.misc.ntp.getTime')
    @patch('qsc.core.p2p.p2pprotocol.logger', autospec=True)
    @patch('qsc.core.p2p.p2pprotocol.config.dev', autospec=True)
