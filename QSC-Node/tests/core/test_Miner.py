...
from qsc.core.Miner import Miner
from qsc.core.TransactionPool import TransactionPool
from qsc.core.misc.helper import parse_qaddress
...
class TestMiner(TestCase):
    ...
    def test_start_mining_works(self, m_getTime, m_logger):
        ...
        with patch('qsc.core.miners.qryptonight7.CNv1Miner.CNv1Miner.start', spec=True) as m_start:
...
class TestMinerWithRealTransactionPool(TestCase):
    ...
    @patch('qsc.core.Miner.Block.create')
