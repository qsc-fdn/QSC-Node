...
from qsc.cli import qrl as qrl_cli
...
@mock.patch('qsc.cli.grpc.insecure_channel', new=mock.MagicMock())
...
class TestCLI(TestCase):
    ...
    @mock.patch('qsc.cli.qrl_pb2_grpc.PublicAPIStub', autospec=True)
    ...
    @mock.patch('qsc.cli.config', autospec=True)
    @mock.patch('qsc.cli.Transaction', autospec=True)
    @mock.patch('qsc.cli.qrl_pb2_grpc.PublicAPIStub', autospec=True)
